...
public class UserInstructorServiceImpl implements UserInstructorService {
    ...
    public UserInstructor create(UserInstructor userInstructor) {
        ...
        if(userInstructorRepository.existsByUsername(userInstructor))
            throw USER_INSTRUCTOR_IDENTIFIER_DUPLICATE_ENTITY_EXCEPTION.apply(userInstructor.getUsername());
        if(userInstructorRepository.existsByEmail(userInstructor))
        ...
        return userInstructorRepository.insert(userInstructor);
    }
